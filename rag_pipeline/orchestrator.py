...
from safety_guardrails.prompt_guard import get_prompt_guard_detector
from safety_guardrails.post_generation import check_grounding, DECLINED_RESPONSE_TEMPLATE
from llm_synthesis.extractive import generate_extractive
from llm_synthesis.answer_cache import get_answer_cache
from llm_synthesis.llm_fallback import get_llm_adapter
from voice_stt.sarvam_client import get_stt_client
...
class RAGPipelineOrchestrator:
    ...
    async def execute(self, request: QueryRequest) -> QueryResponse:
        ...
        if config.ENABLE_LOCAL_SLM:
            ...
            from llm_synthesis.local_slm import get_local_slm_adapter
            context_blocks = []
